...
from autoparser.create_mapping import Mapper, create_mapping
from autoparser.dict_writer import DictWriter, create_dict, generate_descriptions
from autoparser.make_toml import ParserGenerator, create_parser
...
from autoparser.dict_writer import main as make_dd_main
from autoparser.dict_writer import api_descriptions_only as add_descriptions_main
from autoparser.create_mapping import main as csv_mapping_main
from autoparser.make_toml import main as make_toml_main
